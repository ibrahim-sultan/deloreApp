...
router.post('/', auth, async (req, res) => {
    ...
    const { name, address, contactNumber, email, contactPerson, caseWorkerName, businessType, notes, coordinates } = req.body;
...
router.put('/:id', auth, async (req, res) => {
    ...
    try {
        ...
        if (typeof caseWorkerName !== 'undefined') client.caseWorkerName = caseWorkerName;
