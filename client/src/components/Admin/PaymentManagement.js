          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="delete-confirmation">
              ...
              <div className="payment-info-preview">
                <p><strong>Staff:</strong> {deleteConfirm.staffMember?.name}</p>
                <p><strong>Amount:</strong> {formatCurrency(deleteConfirm.amount)}</p>
                <p><strong>Date:</strong> {formatDate(deleteConfirm.paymentDate)}</p>
              </div>
              <p className="warning-text">
                This action cannot be undone. The payment record and receipt will be permanently deleted.
              </p>
              <div className="form-actions">
                ...
                <button
                  ...
                  onClick={() => handleDeletePayment(deleteConfirm._id)}
                  disabled={deleting}
                >
